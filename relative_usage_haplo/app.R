...
absolute_thresholds_dict <- list(
  ...
  "IGHV3-23G19" = c("V3-23D*01/V3-23*01" = 0.001, "V3-23*04" = 0.001),
  "IGHV3-30G20" = c(
    "V3-30-3*01" = 0.0001,
    "V3-33*01" = 0.0001,
    "V3-30*03" = 0.0001,
...
server <- function(input, output, session) {
  input_vals <-
    reactiveValues(
      tabs_count = 0,
      g_group = "IGHV4-4G41",
      g = allele_db %>% dplyr::filter(gene_group == "IGHV4-4G41") %>% pull(gene) %>% unique(),
      v_gene_cut = "IGHV4-4G41",
      allele_thresh = NULL,
