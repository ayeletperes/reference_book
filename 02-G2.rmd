...
From the results we believe that the cutoff for this group should be closer to $5\%$ except allele **05** that should stay at $0.5\%$, and for the adjusted states the allele combinations and the relations are stated in the table below.
