...
invisible(rmarkdown::pandoc_convert(input = "IGHV1-18.docx", to = "markdown", output = "IGHV1-18_docx.md", options = c("--wrap=none","--reference-links","--metadata-file=metadata.yaml"), verbose = FALSE))
...
server <- function(input, output) {
  ...
  observeEvent(input$ab2, {
      ...
      rmarkdown::pandoc_convert(input = "IGHV1-18.docx", to = "markdown", output = "IGHV1-18_docx.md", options = c("--wrap=none","--reference-links","--metadata-file=metadata.yaml"), verbose = F)
      output$markdown <- renderUI({
        withMathJax(includeMarkdown(knitr::knit('./IGHV1-18_docx.md', quiet = TRUE)))
    })
    
  })
  
  output$markdown <- renderUI({
    includeMarkdown(knitr::knit('./IGHV1-18_docx.md', quiet = TRUE))
  })
}
