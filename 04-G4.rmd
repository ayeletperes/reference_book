...
From the results we believe that the cutoff for this group should be closer to $5\%$ for alleles **01** and **05**, and for allele **04** it should stay at $0.5\%$, and for the adjusted states the allele combinations and the relations are stated in the table below.

### Allele specific cutoff: 5\% for alleles **01,05** except 0.5\% for allele **05**
